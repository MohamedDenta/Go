...
// GetAccountBalance function to get the account balance
...
//GetTransactionsByPublicKey get tx by pk
func GetTransactionsByPublicKey(accountObj accountdb.AccountStruct) map[string][]jsonTransactions {
	...
	for _, blockObj := range accountObj.BlocksLst {
		decryptedIndex := cryptogrpghy.KeyDecrypt("123456789", blockObj)
...
//GetTransactionsByTokenID get transaction by token id
...
//GetAccountBalanceStatement get account balance
